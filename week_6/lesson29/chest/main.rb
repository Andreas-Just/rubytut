...
# Теперь мы можем быть уверены, что файл на диске в нужном месте точно есть.
# Если он был — хорошо, если нет — мы его создали, без данных но с нужной нам
...
# к нему атрибут date со строкой даты в нужном формате
