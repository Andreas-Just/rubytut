...
questions = [
  ...
  'Вы расспрашиваете вашего партнера о работе, о коллегах?',
  'Вы считаете, что каждую свободную минуту должны проводить вместе?',
  'Он для вас — свет в окошке?',
  'Случается ли вам проверять его корреспонденцию и рыться в вещах вашего партнера?',
  'Чем чаще ваш партнер говорит о своих чувствах, тем меньше вы верите?',
  'Вы хотите, чтобы ваш партнер интересовался только тем, чем интересуетесь вы?',
  'Вы всегда спрашиваете у вашего партнера, куда он/она ходит и с кем встречается?',
  'Если вы обижены на вашего партнера, то молчите по нескольку дней?',
  'Вас мучают мысли о бывшей/ем возлюбленной/ом вашего партнера?',
  'Ваш партнер утверждает, что не ревнует вас, потому что доверяет. Для вас это ' \
...
results = [
  ...
  'непривлекательной/ым и боитесь, что он/она бросит вас ради какой/ого нибудь ' \
  'красавицы/вца. Вы ни в чем не уверены, особенно в нем/ней. Задумайтесь над этим, ' \
  'потому что нельзя быть настолько ревнивой/ым и агрессивной/ым, это может ' \
