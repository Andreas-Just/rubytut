...
version = "Тест \"Ваш уровень общительности\". Версия 0.8. (с) andrew-just\n\n"
...
questions.each.with_index { |question, index |
  ...
  until user_input == yes_answer || user_input == sometimes_answer || user_input == no_answer
    puts 'Введите \'yes\', \'may be\' или \'no\' и нажмите Enter'
