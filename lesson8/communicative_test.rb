...
results = [
  # 30-31 балл
  [(32..32), 'Возможно вы аутист? Если у вас: отсутствует эмоциональный контакт с людьми; реакция на внешние раздражители слабы; мимическая маска глубокого покоя; характерное полевое поведение (бесцельное перемещение по комнате); избегание сильных стимулов, вызывающих страх (шум, яркий свет, прикосновение и т.д.). Вам следует обратиться к врачу.'],
